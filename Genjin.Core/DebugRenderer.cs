...
public class DebugRenderer : IDebugRenderer {
    ...
    public readonly record struct RectangleDrawing(Box Rectangle, Color Color, float Thickness, float LayerDepth);
    ...
    public void DrawRectangle(Box rectangle, Color color, float thickness = 1, float layerDepth = 0) => Rectangles.Add(new RectangleDrawing(rectangle, color, thickness, layerDepth));
    ...
    public void FillRectangle(Box rectangle, Color color, float layerDepth = 0) => Rectangles.Add(new RectangleDrawing(rectangle, color, 0, layerDepth));
