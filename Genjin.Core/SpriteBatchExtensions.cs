...
public static class SpriteBatchExtensions {
    public static void DrawSprite(this VeldridSpriteBatch spriteBatch, TextureWrapper textureWrapper,
        Rectangle sourceRectangle, Transform2 transform, SpriteOptions spriteEffects = SpriteOptions.None,
        float layerDepth = 0) =>
    ...
    public static void DrawSprite(this VeldridSpriteBatch spriteBatch, TextureWrapper textureWrapper,
        Transform2 transform, SpriteOptions spriteEffects = SpriteOptions.None, float layerDepth = 0) =>
    ...
    public static void DrawSprite(this VeldridSpriteBatch spritebatch, SpriteSheet spriteSheet, int spriteSheetIndex,
        Transform2 transform, SpriteOptions spriteEffects = SpriteOptions.None) {
