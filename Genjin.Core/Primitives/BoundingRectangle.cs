...
public struct BoundingRectangle : IEquatable<BoundingRectangle>
{
    ...
    {
        Transform(ref boundingRectangle, ref transformMatrix, out var result);
        return result;
    }
