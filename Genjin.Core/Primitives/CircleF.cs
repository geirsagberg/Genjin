...
public struct CircleF : IEquatable<CircleF>, IShapeF {
    ...
    public Vector2 ClosestPointTo(Vector2 point) {
        ...
        return Center + (Radius * distanceVector.NormalizedCopy());
    }
    ...
    public bool Equals(CircleF other) => Center.Equals(other.Center) && Radius.Equals(other.Radius);

    public override bool Equals(object? obj) => obj is CircleF other && Equals(other);
